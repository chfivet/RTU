"""
Django settings for RTU project.
...
SECRET_KEY = 'django-insecure-h5*_@lyhv4%lt&l5l=a=pe(dtbw##o@2xe#l9v&h8r#bbm4p3l'
...
WSGI_APPLICATION = 'RTU.wsgi.application'
